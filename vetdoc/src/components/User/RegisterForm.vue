    ...
    <div class="form-box">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="form-group">
          <input v-model="firstName" type="text" placeholder="Ime" />
          <span v-if="errors.firstName">{{ errors.firstName }}</span>
        </div>

        <div class="form-group">
          <input v-model="lastName" type="text" placeholder="Prezime" />
        ...
        <div class="form-group">
          <input v-model="confirmPassword" type="password" placeholder="Potvrdi lozinku" />
...
const validate = () => {
  ...
  if (password.value !== confirmPassword.value) errors.value.confirmPassword = 'Lozinke se ne podudaraju.'
